...
class ACMsgType(Enum):
    ...
    # INFORM_EP = auto()  # inform the EP for entanglement purification
...
class AdaptiveContinuousMessage(Message):
    ...
    def __init__(self, msg_type: ACMsgType, reservation: ReservationAdaptive, **kwargs):
        ...
        # elif self.msg_type == ACMsgType.INFORM_EP:    # for the entanglement purification protocol
        #     self.entanglement_pairs = kwargs['entanglement_pairs']
        #     self.string += f', entanglement_pairs = {self.entanglement_pairs}'
...
class AdaptiveContinuousProtocol(Protocol):
    ...
    def received_message(self, src: str, msg: ACMsgType) -> None:
        ...
        #     entanglement_pair  = (entanglement_pair[1],  entanglement_pair[0])
        #     entanglement_pair2 = (entanglement_pair2[1], entanglement_pair2[0])
        #     self.remove_entanglement_pair(entanglement_pair)     # remove the EP from AC Protocol
        #     self.remove_entanglement_pair(entanglement_pair2)
        #     purification_protocol = self.create_purification_protocol(entanglement_pair, entanglement_pair2)
    ...
    def get_entanglement_pair2(self, entanglement_pair: tuple) -> Optional[tuple]:
        '''given an entanglement_pair, find an other entanglement_pair between the same two nodes (for purification). Both two nodes select the freshest.
        ...
        for ep in self.generated_entanglement_pairs:
            if ep != entanglement_pair and ep[0][0] == this_node and ep[1][0] == other_node:
                eps.append(ep)
        if eps:
            freshest_ep = None
            best_fidelity = 0
    ...
    def create_purification_protocol(self, entanglement_pair: tuple, entanglement_pair2: tuple, rule: Rule) -> BBPSSW_bds:
        ...
        # empty_rule = Rule(None, None, None, None, None)
        # purification_protocol.rule = empty_rule
