...
class SwapMemoryProtocol(EntanglementProtocol):
    ...
    def received_message(self, src: str, msg: Message):
        ...
        '''
        log.logger.debug(f'{self.name} received message {msg} from {src}')
    ...
    def start(self) -> None:
        ...
        if self.primary:
            ...
            process = Process(self, 'swap_memory', [entangled_memory_name])
    ...
    def swap_memory(self, entangled_memory_name: str):
        '''swap memory between self.memory and the memory that entangle_memory_name is referring to
        Args:
            entangled_memory_name: the name of the entangled memory on this node
        '''
        log.logger.info(f'Swap memory between {self.memory.name} and {entangled_memory_name}')
        self.owner.resource_manager.swap_two_memory(self.memory.name, entangled_memory_name)
