...
class EntanglementGenerationAadaptive(EntanglementProtocol):
    ...
    Attributes:
        ...
        from_request (bool): if true, then the EG protocol is generated from a request
                             if False, then the EG protocol is generated from a AC protocol
    """
    ...
    def __init__(self, owner: "Node", name: str, middle: str, other: str, memory: "Memory", from_request: bool):
    ...
    def start(self) -> None:
        ...
        if self.update_memory() and self.primary:
            ...
            if self.from_request is False:   # EGA protocol is generated from the adaptive continuous protocol
